...
|              | 1.2. 로그인      |                    | (POST) 아이디와 비밀번호를 입력받아 로그인                              |
|              | 1.3 정보 조회    |                    | (GET) 마이페이지에서 회원 본인의 정보 확인                              |
|              | 1.4 정보 수정    |                    | (POST) 마이페이지에서 회원 본인의 정보 수정                             |
| 2. 책 관리   | 2.1. 책 생성     | 2.1.1. 생성        | (POST) 책 제목, 작가, 출판사, 출판년도, 작성자 정보를 입력 받아 책 생성 |
|              | 2.2 책 목록      | 2.2.1 책 목록 정보 | (GET) DB에서 책 목록을 받아 화면에 출력                                 |
|              |                  | 2.2.2 페이징       | (GET) Limit을 활용하여 페이징 시스템 구현                               |
|              | 2.3 책 상세 보기 |                    | (GET) 책 목록에서 책 클릭 시 해당 책의 상세 정보 확인                   |
|              | 2.5 수정         |                    | (GET) 책 상세 보기에서 본인이 작성하였다면 수정 가능                    |
|              | 2.6 삭제         |                    | (GET) 책 상세 보기에서 본인이 작성하였다면 삭제 가능                    |
